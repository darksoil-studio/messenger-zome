import"./show-avatar-image.BZm0lwcV.js";import{p as w}from"./agent-avatar.BvZW1j7G.js";import{i as f,x as r,m as n,f as v,g,r as $}from"./messenger-client.Xgv8kjK5.js";import{a as d,c as y,t as A}from"./property.9e9_4Dyz.js";import{c as b,_ as c,S as x,e as k,w as C,a as _,m as P,b as G,l as D}from"./styles.B87_XgVZ.js";import"./chunk.UJ4C5V3J.FPLQwGNR.js";import{S as T}from"./signal-watcher.CCnljk_y.js";import{m as N}from"./context.CjZT0WpV.js";import"./tslib.es6.kHcLnhpD.js";import"./reactive-element.ChgaCBqn.js";var H=f`
  :host {
    display: inline-flex;
  }
...
`,p=class extends x{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return r`
    ...
    `}};p.styles=[b,H];c([d({reflect:!0})],p.prototype,"variant",2);c([d({type:Boolean,reflect:!0})],p.prototype,"pill",2);c([d({type:Boolean,reflect:!0})],p.prototype,"pulse",2);p.define("sl-badge");var z=f`
  :host {
...
`,h=class extends x{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};h.styles=[b,z];c([d({type:Boolean,reflect:!0})],h.prototype,"vertical",2);c([C("vertical")],h.prototype,"handleVerticalChange",1);h.define("sl-divider");/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*M(e,t){const a=typeof t=="function";if(e!==void 0){let s=-1;for(const l of e)s>-1&&(yield a?t(s):t),s++,yield l}}var O=Object.defineProperty,j=Object.getOwnPropertyDescriptor,m=(e,t,a,s)=>{for(var l=s>1?void 0:s?j(t,a):t,i=e.length-1,u;i>=0;i--)(u=e[i])&&(l=(s?u(t,a,l):u(l))||l);return s&&l&&O(t,a,l),l};let o=class extends T($){renderPeerChat(e){const t=e.lastActivity.event.content;return r`<div
			class="row"
		...
		>
			...
			${M(e.map(t=>t.type==="PeerChat"?this.renderPeerChat(t):this.renderGroupChat(t)),r`<sl-divider></sl-divider>`)}
		...
		`];m([y({context:N,subscribe:!0})],o.prototype,"store",2);m([y({context:w,subscribe:!0}),d()],o.prototype,"profilesProvider",2);o=m([D(),A("all-chats")],o);export{o as AllChats};
