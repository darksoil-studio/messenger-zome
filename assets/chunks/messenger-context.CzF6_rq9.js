import{l as h}from"./context.CEPY6pde.js";import{r as g,b as a,a as m,x as u,i as f}from"./messenger-client.Xgv8kjK5.js";import{e as v,a as b}from"./context.DIdWcKoJ.js";import{a as l,c as x,t as d}from"./property.9e9_4Dyz.js";import{m as y}from"./context.CjZT0WpV.js";var w=Object.defineProperty,C=Object.getOwnPropertyDescriptor,o=(s,r,i,n)=>{for(var t=n>1?void 0:n?C(r,i):r,c=s.length-1,p;c>=0;c--)(p=s[c])&&(t=(n?p(r,i,t):p(t))||t);return n&&t&&w(r,i,t),t};let e=class extends g{constructor(){super(...arguments),this.zome="messenger"}connectedCallback(){if(super.connectedCallback(),!this.store){if(!this.role)throw new Error('<messenger-context> must have a role="YOUR_DNA_ROLE" property, eg: <messenger-context role="role1">');if(!this.client)throw new Error(`<messenger-context> must either:
