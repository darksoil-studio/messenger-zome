import{a as rt,b as st,H as nt,c as B,S as I,L as U,I as H,J as T,n as q,_ as s,d as R,r as L,w as at,e as Y,o as W,l as lt,F as K,K as j,M as d,E as X,N as it}from"./styles.D7lbDD0V.js";import{i as y,x as v,E as V,p as E,u as A,r as J,m as ut,q as D,T as $}from"./messenger-client.Bks7hfH7.js";import{n,t as Q,b as G,c as ct}from"./property.BL0qaIkn.js";import{_}from"./tslib.es6.kHcLnhpD.js";import{S as Z,p as dt}from"./signal-watcher.CurgRbfO.js";function ht(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function bt(t,e="primary",o=st,r=3e3){const l=Object.assign(document.createElement("sl-alert"),{variant:e,closable:!0,duration:r,innerHTML:`
...
`,c=class extends I{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,e=t?E`a`:E`button`;return A`
    ...
    </div>`}static get styles(){return[G,y`
        :host {
          display: flex;
        }
      `]}};M=_([Q("profile-list-item-skeleton")],M);let h=class extends Z(J){profile(){if(this.profileHash)return this.store.profiles.get(this.profileHash).latestVersion.get();if(this.agentPubKey){const e=this.store.profileForAgent.get(this.agentPubKey).get();return e.status!=="completed"?e:e.value===void 0?{status:"completed",value:void 0}:e.value.latestVersion.get()}else throw new Error("Either agentPubKey or profileHash needs to be defined for the agent-avatar element")}render(){var e;const o=this.profile();switch(o.status){case"pending":return v`<profile-list-item-skeleton></profile-list-item-skeleton>`;case"completed":return v`
				...
				`;case"error":return v`<display-error
					...
					.error=${o.error}
				></display-error>`}}};h.styles=[G];_([n(W("agent-pub-key"))],h.prototype,"agentPubKey",void 0);_([n(W("profile-hash"))],h.prototype,"profileHash",void 0);_([ct({context:dt,subscribe:!0}),n()],h.prototype,"store",void 0);h=_([lt(),Q("profile-list-item")],h);/**
 * @license
