import{_ as t}from"./tslib.es6.kHcLnhpD.js";import{n as s,a as o,c as i,t as n,p}from"./property.CdyGxQ3i.js";import{e as r,a as l}from"./context.DRhR2QFt.js";import{P as c,c as a,x as f,r as x,i as m}from"./messenger-client.CJVut2Sl.js";import{S as h}from"./signal-watcher.CwHglHdS.js";const d=s("hc_zome_profiles/store");let e=class extends h(x){constructor(){super(...arguments),this.zome="profiles"}connectedCallback(){if(super.connectedCallback(),!this.store){if(!this.role)throw new Error('<profiles-context> must have a role="YOUR_DNA_ROLE" property, eg: <profiles-context role="role1">');if(!this.client)throw new Error(`<profiles-context> must either:
