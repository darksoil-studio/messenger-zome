import{m as lt,a as it,I as nt,c as T,S as E,L as Y,J as j,K as D,k as W,_ as a,f as B,r as I,w as L,e as V,n as ut,l as dt,E as K,M as X,N as h,D as J,O as ct}from"./styles.fvlugEG2.js";import{i as p,x as b,E as A,l as S,u as z,r as Q,m as ht,n as H,T as $}from"./messenger-client.CV9csWrB.js";import{a as s,t as G,b as Z,c as bt,p as pt}from"./property.Du0Z6lUr.js";import{_ as O}from"./tslib.es6.kHcLnhpD.js";import{S as tt}from"./signal-watcher.1XZcQCR5.js";function ft(t){const o=document.createElement("div");return o.textContent=t,o.innerHTML}function mt(t,o="primary",e=lt,r=3e3){const u=Object.assign(document.createElement("sl-alert"),{variant:o,closable:!0,duration:r,innerHTML:`
...
`,c=class extends E{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,o=t?S`a`:S`button`;return z`
    ...
    `}};c.styles=[T,yt];c.dependencies={"sl-icon":W};a([B(".icon-button")],c.prototype,"button",2);a([I()],c.prototype,"hasFocus",2);a([s()],c.prototype,"name",2);a([s()],c.prototype,"library",2);a([s()],c.prototype,"src",2);a([s()],c.prototype,"href",2);a([s()],c.prototype,"target",2);a([s()],c.prototype,"download",2);a([s()],c.prototype,"label",2);a([s({type:Boolean,reflect:!0})],c.prototype,"disabled",2);let q=class extends tt(Q){render(){return b`<div class="row" style="align-items: center; width: 150px">
      ...
      `]}};q=O([G("profile-list-item-skeleton")],q);let _=class extends tt(Q){render(){var e;const o=this.profilesProvider.currentProfileForAgent.get(this.agentPubKey).get();switch(o.status){case"pending":return b`<profile-list-item-skeleton></profile-list-item-skeleton>`;case"completed":return b`
				...
				`;case"error":return b`<display-error
					...
					.error=${o.error}
				></display-error>`}}};_.styles=[Z];O([s(ut("agent-pub-key"))],_.prototype,"agentPubKey",void 0);O([bt({context:pt,subscribe:!0}),s()],_.prototype,"profilesProvider",void 0);_=O([dt(),G("profile-list-item")],_);/**
 * @license
