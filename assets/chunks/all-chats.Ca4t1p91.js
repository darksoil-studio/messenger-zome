import"./show-avatar-image.B9DanR2O.js";import{c as y,_ as d,S as b,e as w,w as $,a as A,m as k,p as _,l as C,b as G}from"./styles.BcPDAjHV.js";import{i as f,x as s,m as l,f as u,r as D,g as v}from"./messenger-client.Bks7hfH7.js";import{S as P}from"./signal-watcher.DchcTGV4.js";import{a as g,c as x,t as T}from"./property.BEi3PmIb.js";import"./chunk.RWPQHXWX.DBFmzxw3.js";import{m as N}from"./context.BqoJQclL.js";import"./tslib.es6.kHcLnhpD.js";import"./reactive-element.CHpx6ykd.js";var H=f`
  :host {
    display: inline-flex;
  }
 ...
 */function*M(e,t){const n=typeof t=="function";if(e!==void 0){let r=-1;for(const a of e)r>-1&&(yield n?t(r):t),r++,yield a}}var O=Object.defineProperty,j=Object.getOwnPropertyDescriptor,m=(e,t,n,r)=>{for(var a=r>1?void 0:r?j(t,n):t,i=e.length-1,p;i>=0;i--)(p=e[i])&&(a=(r?p(t,n,a):p(a))||a);return r&&a&&O(t,n,a),a};let o=class extends P(D){renderPeerChat(e){const t=e.lastActivity.signed_content.content;return s`<div
		...
		>
			...
			${M(e.map(t=>t.type==="PeerChat"?this.renderPeerChat(t):this.renderGroupChat(t)),s`<sl-divider></sl-divider>`)}
				...
				`;case"error":return s`<display-error
					...
					.error=${e.error}
				></display-error>`;case"completed":return this.renderChats(e.value)}}};o.styles=[k,f`
			:host {
				display: flex;
			}
			.last-activity {
		...
		`];m([x({context:N,subscribe:!0})],o.prototype,"store",2);m([x({context:_,subscribe:!0})],o.prototype,"profilesStore",2);o=m([C(),T("all-chats")],o);export{o as AllChats};
