import{l as b}from"./context.lHSmWYFG.js";import{t as $,f as p,x as a,m,j as S,k as H,r as _,i as P}from"./messenger-client.CrBQT6S4.js";import{S as M}from"./context.CP7mVcaJ.js";import{n as I,a as T}from"./chunk.UG6RICOR.KWXIwe3b.js";import{a as x,c as C,t as A}from"./property.COiWTaZV.js";import{e as D,b as E,n as w,l as B}from"./styles.1LkFSSyP.js";import"./chunk.UJ4C5V3J.BgoNkNvF.js";import{o as j}from"./message-input.DQKNX8xp.js";import{m as z}from"./context.BUoRP9Rb.js";import"./tslib.es6.kHcLnhpD.js";var O=Object.defineProperty,k=Object.getOwnPropertyDescriptor,d=(e,t,s,r)=>{for(var n=r>1?void 0:r?k(t,s):t,o=e.length-1,l;o>=0;o--)(l=e[o])&&(n=(r?l(t,s,n):l(n))||n);return r&&n&&O(t,s,n),n};let h=class extends M(_){async firstUpdated(){if(!this.peer&&!this.peerChatHash)throw new Error('peer-chat must be initialized with either the "peerChatHash" or the "peer" input.');if(this.peer&&!this.peerChatHash){const e=await $(this.store.peerChatsForPeer.get(this.peer));e.length===0?this.peerChatHash=await this.store.client.createPeerChat(this.peer):this.peerChatHash=e[0]}}renderTopBar(e){const t=e.peer_1.agents.find(s=>p(s)===p(this.store.client.client.myPubKey))?e.peer_2:e.peer_1;return a`
			<div
				part="top-bar"
				class="row top-bar"
