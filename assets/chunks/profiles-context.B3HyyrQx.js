import{_ as t}from"./tslib.es6.kHcLnhpD.js";import{n as s,a as o,c as i,t as n,p}from"./property.rnZ96Gce.js";import{e as r,a as l}from"./context.Dp6U7mwm.js";import{P as c,c as a,x as f,r as x,i as m}from"./messenger-client.BdwBMR5i.js";import{S as h}from"./signal-watcher.Dnw_ZDU5.js";const d=s("hc_zome_profiles/store");let e=class extends h(x){constructor(){super(...arguments),this.zome="profiles"}connectedCallback(){if(super.connectedCallback(),!this.store){if(!this.role)throw new Error('<profiles-context> must have a role="YOUR_DNA_ROLE" property, eg: <profiles-context role="role1">');if(!this.client)throw new Error(`<profiles-context> must either:
